...
<!--@component
    - Part of the Dropdown component
    - Concept by TreltaSev, Amaan Dhanani is updating it since
    - TreltaSev made component, generated by SvelteForge🔥
    ...
    - `href`: Optional string — if present, clicking the button will navigate to the given URL.
    - `onclick`: Optional event handler, overridden if `href` is present.

    @context
    Pulls shared class context via `getDropdownCtx()`:
